  ...
  return (
    <div className="min-h-screen bg-[#f6f5ef] text-[#15222c]">
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 flex w-[264px] flex-col border-r border-[#dfe3dc] bg-[#fbfbf7] px-5 py-6 transition-transform duration-300 lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className="mt-5 flex items-center gap-3 border-t border-[#e5e8e1] px-2 pt-5"><div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#dbe4dc] text-xs font-bold">HR</div><div><p className="text-xs font-bold">Hiring workspace</p><p className="text-[11px] text-[#8b9690]">Team account</p></div></div>
      </aside>
